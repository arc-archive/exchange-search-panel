...
declare namespace UiElements {
   ...
   *
   * ```html
   * <exchange-search-panel on-process-exchange-asset-data="_getAssetDetails" action-label="Details"></exchange-search-panel>
   * ```
   *
   * ### New in version 2.0
   *
  ...
  class ExchangeSearchPanel extends Polymer.Element {
    ...
    _scrollTargetChanged(scrollTarget: any): void;
     ...
     *
     * @param isOpened The _isOpened propery value.
     */
    _checkLoad(isOpened: Boolean|null): void;
